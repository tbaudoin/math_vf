\documentclass[parskip=half-, numbers=enddot, DIV=15]{scrartcl}
...
\subsection{Unités d'acquis d'apprentissage (Travail journalier certificatif - TJC)}

Les chapitres vus durant l'année sont regroupés au sein d'unités. À la fin de chaque unité, une évaluation certificative aura lieu. Ce sont ces évaluations (60~\%) ainsi que l'examen de fin d'année (40~\%) qui détermineront la réussite du cours de mathématiques. 
