...
Les chapitres vus durant l'année sont regroupés au sein d'unités. À la fin de chaque unité, une évaluation certificative aura lieu. Ce sont ces évaluations ainsi que l'examen de fin d'année qui détermineront la réussite du cours de mathématiques. Le tableau suivant reprend les différentes unités ainsi que leur pondération.
\begin{center}
	\begin{tblr}{}
		\toprule
		Unité    &
