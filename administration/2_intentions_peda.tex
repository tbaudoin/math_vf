...
\subsection{Évaluations régulières ( Travail journalier - TJ)}
...
\subsection{Bilans de chapitres (B)}

Il s'agit des interrogations qui reprennent l'ensemble des matières d'un chapitre ou de plusieurs chapitres.

\subsection{Bulletin}
Les points de toutes les interrogations (TJ et B) sont prises en compte dans le bulletin. Toutefois, les bilans auront plus de poids dans la côte finale.

% \subsection{Pondération}

% L'année est évaluée sur un total de 100 points (hors CE1D). \\
% La pondération du cours de mathématiques se fait selon la règle suivante: 
% \begin{itemize}
%   \item Toutes les périodes portent sur 14 points, à raison de 4 points pour le TJ et 10 points pour les bilans.
...
%     \toprule
%     P1 & P2 & Noël & P3 & P4 & P5 & Total \\
%     \midrule
%     14 & 14 & 30   & 14 & 14 & 14  & 100 \\
%     \bottomrule
%   \end{tblr}
% \end{center}
...
Le critère de réussite du cours de mathématiques est d'obtenir une note dépassant ou égalant les 50\% à l'épreuve externe du CE1D.
