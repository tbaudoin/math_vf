...
\subsection{Évaluation de compétence (Travail journalier certificatif)}

Il s'agit d'évaluations qui reprennent l'ensemble des matières d'un chapitre ou de plusieurs chapitres.

Le tableau suivant reprend les différents évaluations ainsi que leur pondération.
\begin{center}
    \begin{tblr}{}
        \toprule
        Chapitre                    & Pondération \\
        \midrule
        Notions de statistiques             & a voir          \\
        Valeurs centrales & a voir          \\
        Équations du premier degré & a voir          \\
        Fonctions du premier degré & a voir          \\
        Intersection de graphique de fonctions & a voir          \\
        Inéquations du premier degré & a voir          \\
        \bottomrule
                                    & 100
    \end{tblr}
\end{center}
...
Les évaluations certificatives seront corrigées et signées avant d'être rangées dans le
dossier d'apprentissage. Elles sont classées par ordre chronologique (du
plus récent au plus ancien) et la feuille récapitulative, appelée
répertoire, sera placée comme page de garde.
...
Le critère de réussite du cours de mathématiques est d'obtenir une note dépassant ou égalant les 50\% en cumulant les points des évaluations certificatives et des examens.
