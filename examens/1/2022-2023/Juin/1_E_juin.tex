...
\begin{transferer}[points=4]
    ...
    \begin{enumerate}[itemsep=1cm, after=\vspace*{
        ...
        \item Complète ce tableau.
              ...
              \item Détermine le numéro de la rangée qui comporte 31 canettes en utilisant ta formule. \vspace{2cm}
    ...
    \begin{minipage}{.45\linewidth}
        \begin{center}
            \begin{enumerate}[itemsep=.4cm]
                ...
                \item \(t_{\overrightarrow{UN}}(Q)=\blank[width=1cm]{}\)
