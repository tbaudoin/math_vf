...
\begin{tblr}{%
    ...
    % cell6
    Date et heure : Mercredi 26 juin 2024 de 8 h 20 à 10 h 30                   \\
    % cell7
...
\begin{appliquer}[points=10]
    Réduis au maximum. Si tu ne peux pas réduire l'expression, recopie-la.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%TODO: Flèche sur le tableau ATTENTION en attendant c'est mis dans la consigne, à changer lorsqu'on aura réussi à mettre les flèches 
...
\begin{appliquer}[points=3]
    ...
    \begin{enumerate}
        \item Dans la première colonne, indique s'il s'agit d'une translation (T), d'une symétrie centrale (SC), d'une symétrie orthogonale (SO) ou d'une rotation (R).
        \item Dans la deuxième colonne, cite l'élément caractéristique de cette transformation du plan.
    \end{enumerate}
    \begin{center}
        \includegraphics[width=.6\linewidth]{tikz/figure001.tikz}
    \end{center}
    \begin{center}
        \begin{tblr}{
                hlines,
                ...
                cell{1}{1}={white}
                     ...
                     & Isométrie & Élément(s) caractéristique(s) \\
            De 2 à 4 &           &                         \\
            De 3 à 4 &           &                         \\
            De 1 à 4 &           &                         \\
        \end{tblr}
...
\begin{transferer}[points=4]
    ...
    \begin{enumerate}[itemsep=2cm, after=\vspace*{3cm}]
        \item Exprime à l'aide d'une expression littérale réduite au maximum le périmètre de la salle de Stockholm.
