...
\begin{center}
	\textbf{Sur feuille annexe, à part si l'énoncé en dit autrement. La calculatrice n'est PAS autorisée, à part pour les énoncés qui le stipulent}
\end{center}
...
\begin{exercise}
	Calcule les pourcentages suivants. Arrondis à 2 chiffres après la virgule si besoin. \\ \textbf{Calculatrice autorisée}
	\begin{enumerate}[cols=4]
		\item 30\% de \SI{120}{g}
		\item 20\% de 366€
...
\begin{exercise}
	Construis un ennéagone régulier dans un cercle de \SI{6}{cm} de rayon. Nomme-le.
\end{exercise}
...
\begin{exercise}
    ...
    \begin{enumerate}[cols=2]
        ...
        \item multiples pairs de 7 inférieurs à 50
        \item multiples impairs de 3 inférieurs à 25
