...
\includegraphics[width=\linewidth]{img/entete.pdf}
    ...
    \begin{tblr}{%
        ...
        Prénom : && Numéro :  \\
        % cell5
        Professeurs :  Baudoin, Debroux, Regout &&\TotalExerciseGoal{points}{~point}{~points}\\
        % cell6
...
\begin{appliquer}[points=6]
    ...
    \begin{enumerate}
        ...
        \item La racine de $f_2$ est $-2$ et son graphe est parallèle à celui de la fonction \\$g(x) = 2x + 2$.
              %\item Un tableau de valeur de $f_5$ est le suivant.
              %   $\begin{tblr}{hlines,vlines,columns={1cm,c}}
              %           x    & 4  & 2    & -8 \\
              %           f(x) & 13 & 12,5 & 4
              %       \end{tblr}$
        \item Le graphe de la fonction $f_3$ est le suivant. \hfil\input{tikz/m_p_fct01.tikz}
    \end{enumerate}
\end{appliquer}
% SOLUTION
\begin{solution}
