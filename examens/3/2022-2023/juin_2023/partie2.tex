...
\begin{appliquer}[points=5]
    ...
    \begin{enumerate}[cols=2]
        ...
        \item %2 pts
              $\dfrac{x+1}{x-2}\cdot\dfrac{x^2-4x+4}{x+1}$
    \end{enumerate}
\end{appliquer}
% SOLUTION
\begin{solution}
...
\begin{appliquer}[points=6]
    Pour chaque figure ci-dessous, détermine les grandeurs manquantes en mobilisant la théorie adéquate. Arrondis tes réponses au dixième si nécessaire (une réponse sous forme de fraction ou de racine carrée est préférée).
...
\begin{appliquer}[points=2]
    Le triangle $EDF$ est-il rectangle ?
    \begin{center}
