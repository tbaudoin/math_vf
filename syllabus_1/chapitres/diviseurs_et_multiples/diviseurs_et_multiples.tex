...
%TODO: Refaire mais de façons schématique
...
\includegraphics[width=1\linewidth]{figures/Caractrères de divisibilité.pdf}
...
%FIXME: Enlever la première case
\begin{exercise}
...
\newpage
\begin{exercise}
      Par quel(s) chiffre(s) peut-on remplacer le symbole ($\bullet$) pour que les divisibilités soient vérifiées ?
...
\begin{center}
      ...
      \end{tikzpicture}
\end{center}
Que remarques-tu ? \dotsforanswer{1}
% Le nombre 16 peut être représenté par un carré

Ce nombre possède un nombre impair de diviseur car lorsque tu le décompose en différents produits,
l'un deux possèdera deux facteurs identiques.
\begin{align*}
      1 \cdot 16        & = 16  \\
      2 \cdot 8         & = 16  \\
      \Aboxed{4 \cdot 4 & = 16}
\end{align*}
On trouvera donc que les $div~16=\lbrace 1,2,4,8,16 \rbrace$.

Géométriquement, les nombres carrés font référence à l'aire d'un carré.

\begin{exercise}
      Pour les nombres carrés ci-dessous, est-tu capable de retrouver la longueur du côté du carré ?
...
\begin{exercise}
      ...
      \begin{enumerate}
            \item 1 est un nombre premier.\par\dotsforanswer{2}
            \item Tous les nombres impairs sont des nombres premiers.\par\dotsforanswer{2}
            \item La différence entre deux nombres premiers vaut toujours deux.\par\dotsforanswer{2}
            \item Il n'existe aucun nombre premier qui soit pair.\par\dotsforanswer{2}
            \item Il n'existe pas de nombres premiers consécutifs.\par\dotsforanswer{2}
      \end{enumerate}
\end{exercise}

\begin{exercise}
      Josette explique à son petit frère : \og Il n'existe aucun nombre premier qui termine par 5 \fg{}. Est-ce vrai ? Explique.
      \vspace{5em}
\end{exercise}
...
Par exemple, le nombre $10$ peut s'écrire $2\cdot 5$ et le nombre $30$ peut s'écrire $2\cdot 3 \cdot 5$.
...
\begin{center}
      \begin{tikzpicture}
            %FIXME: Refaire si le temps le permets
            \matrix (decomp) [
                  matrix of nodes,
                  column sep=.5cm,
...
\begin{exercise}
      À l'aide de la page 38 dans ton cahier de théorie, intitulé \og factorisation d'un nombre naturel et diviseur\fg{}, détermine le nombre de diviseurs des nombres de l'exercice précédent.
      \begin{center}
            \begin{tblr}{
                        hlines,
                        vlines,
...
La notation sous forme d'ensemble est un moyen plus court d'écrire les tables de multiplications.
\begin{center}
      \begin{tikzpicture}
...
\begin{exercise}
      Complète les phrases suivantes avec les mots diviseur ou multiple.
      \begin{enumerate}[cols=2, itemsep=2em]
            ...
            \item 125 est un \dotfill de 625.
      \end{enumerate}
\end{exercise}
...
\begin{exercise}
      ...
      \begin{tblr}{
            ...
            cell{6}{5}={gray!40},
            rows={0.5cm, m},
            columns={0.4cm, c, font=\scriptsize},
