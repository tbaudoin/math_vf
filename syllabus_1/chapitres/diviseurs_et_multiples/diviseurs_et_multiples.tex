...
\section{L'histoire du pari le plus cher du monde}
...
\begin{itemize}[label=$\bullet$]
      ...
      \item Le jour 3 : Il reçoit 4 centimes ($2^2$).
      \item Le jour 5 : Il reçoit 16 centimes ($2^4$). 
...
\begin{exercise}
      ...
      \begin{center}
            \begin{tblr}{
                        ...
                        column{1} = {2cm, blue!30, font=\bfseries},
                        rows = {.7cm, m}}
                  Longueur du côté &  &  &  &  &  &  &  &  &  &  &  & $n$ \\
                  Aire du carré    &  &  &  &  &  &  &  &  &  &  &  &     \\
            \end{tblr}
...
%                        vlines,
%                        columns={c},
%                        column{1}= {blue!30, font=\bfseries,l}
%                  }
