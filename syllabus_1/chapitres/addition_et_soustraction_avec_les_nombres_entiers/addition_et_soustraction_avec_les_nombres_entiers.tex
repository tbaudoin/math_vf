...
\begin{enumerate}
    \item Note la température (en \SI{}{\degreeCelsius}) que tu peux lire sur chacun d'eux.
    \item [\label=] \includegraphics[]{chapitres/addition_et_soustraction_avec_les_nombres_entiers/figures/thermo.png}
    \item Fait-il plus froit à \SI{-14}{\degreeCelsius} ou à \SI{-13}{\degreeCelsius} ?
    \item Place le plus précisément possible les températures relevées au-dessus sur cette droite graduée.
