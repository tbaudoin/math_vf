...
\begin{enumerate}
    \item Note la température (en $ \degres C$) que tu peux lire sur chacun d'eux. 
    \item [\label=] \includegraphics[]{chapitres/addition_et_soustraction_avec_les_nombres_entiers/figures/thermo.png}
    \item Fait-il plus froit à $-14\degres C$ ou à $-13\degres C$ \dotfill \par \dotfill
    \item Place le plus précisément possible les températures relevées au-dessus sur cette droite graduée. %TODO: refaire droite graduée
    \item [\label=] \includegraphics[]{chapitres/addition_et_soustraction_avec_les_nombres_entiers/figures/droite graduee -20 40.png}
\end{enumerate}
...
\begin{exercise}
    ...
    3 \hfill -2 \hfill -1 \hfill 2 \hfill 5
   \\
   \includegraphics[]{chapitres/addition_et_soustraction_avec_les_nombres_entiers/figures/droite graduee -4 5.png}
\end{exercise}
