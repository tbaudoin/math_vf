...
\end{equation*}
Cela signifiait concrètement : on donne d'abord un demi-pain à chacun ($\dfrac{1}{2} \times 6 = 3$ pains utilisés), puis un tiers de pain à chacun ($\dfrac{1}{3} \times 6 = 2$ pains utilisés). Le compte est bon !
