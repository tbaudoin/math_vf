...
\end{equation*}
\begin{equation*}
    6 \text{ est la valeur approchée par défaut à l'unité près de } \frac{34}{5}
\end{equation*}
\begin{equation*}
    7 \text{ est la valeur approchée par excès à l'unité près de } \frac{34}{5}
\end{equation*}
...
\begin{exercise}
     Sarah dit : « J'ai bu les $\frac{3}{10}$ d'une bouteille de jus d'orange d'un litre le matin, et j'en ai bu encore $\frac{4}{10}$ durant l'après-midi. »
    \begin{enumerate}
