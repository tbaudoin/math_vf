...
\begin{exercise}
    ...
    \begin{enumerate}[cols=2, itemsep=1.1cm]
...
\begin{exercise}
    ...
    \begin{enumerate}
        ...
        \item  \(108,090\) en supprimant un \og \(0\)\fg pour que la valeur du nombre ne change pas.
        \item  \(108,090\) en supprimant un \og \(0\)\fg pour que la valeur du nombre devienne la plus grande possible.
        \item  \(108,090\) en supprimant un \og \(0\)\fg pour que la valeur du nombre devienne la plus petite possible.
    \end{enumerate}
\end{exercise}
...
\begin{exercise}
    ...
    0,40~€ pièce, 500~gr de fraises au prix de 1~€ pour 100~gr. Ensuite, il
