...
\newpage
\begin{exercise}
    Décode les notations géométriques suivantes. \emph{Sur feuille annexe}
...
\begin{exercise}
    Vrai ou faux? Lorsque c'est faux, justifie ou donne un contre-exemple. \emph{Sur feuille annexe}
    \begin{enumerate}
...
\begin{exercise}
    Place trois points non alignés que tu appelleras $R$, $A$ et $Y$. \emph{Sur feuille annexe}
    \begin{enumerate}[label= $\ast$]
