...
\begin{enumerate}[itemsep=3cm, cols=2, label= ]
    \item Tracé à l'équerre : 
    \item \includegraphics[]{chapitres/rappel_de_geometrie/img/angleA.png}
    \item Tracé au compas : 
    \item \includegraphics[]{chapitres/rappel_de_geometrie/img/angleA.png}
\end{enumerate}
...
\begin{exercise}
    ...
    Trace au compas la bissectrice (\(b\))be cet angle. \\
    Place le point \(K \in b\) bel que \(\overline{KO}=2cm\). \\
