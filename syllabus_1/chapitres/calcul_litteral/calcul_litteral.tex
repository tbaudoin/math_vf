...
\begin{itemize}
    \item un multiple de \(3\) est \(3n\)
    \item un multiple de \(10\) est \(10n\)
    \item un multiple de \(2\) ou un nombre pair est \(2n\)
    \item un nombre impair est \(2n+1\)
\end{itemize}

\exemples
\begin{itemize}
    \item 12 est un multiple de 3 car \(12=3\cdot 4\)
    \item 30 est un multiple de 10 car \(30 = 3 \cdot 10\)
    \item 10 est un nombre pair car \(10 = 2\cdot 5\)
    \item 11 est un nombre impair car \(11=2\cdot 5+1\)
\end{itemize}

\begin{itemize}
    \item deux nombres consécutif est \(n\) et \(n+1\)
    \item trois nombre consécutifs est \(n\), \(n+1\) et \(n+2\)
\end{itemize}
\exemples
\begin{itemize}
    \item 25, 26 et 27 ont trois nombres consécutifs car \(26=25+1\)
\end{itemize}
