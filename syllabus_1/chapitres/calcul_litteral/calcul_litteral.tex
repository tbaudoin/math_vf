...
%\FIXME: refaire ces petites synthèses en plus joli
Pour effectuer un produit entre des expressions algébriques, il suffit de :
\begin{itemize}
    \item multiplier les coefficients entre eux.
    \item multiplier les facteurs littéraux entre eux. C'est-à-dire recopier les différentes lettres dans l'ordre alphabétique et noter en exposant le nombre de fois qu'elles apparaissent.'
\end{itemize}
