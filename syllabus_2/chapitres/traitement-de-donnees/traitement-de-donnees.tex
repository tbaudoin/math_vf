    ...
    \begin{enumerate} [itemsep=1.5cm]
        ...
        \item Complète le tableau de distribution des couleurs de voitures du garage de « Thomas et fils » et calcule l'amplitude des angles afin de tracer un diagramme circulaire. \\
              ...
              \begin{tblr}{hlines, vlines, colspec={*{4}{X[c]}}, rows={m, 1cm}}
                  Variable & Effectif & Fréquence & Amplitude \\
                           &          &           &           \\
                           &          &           &           \\
                           &          &           &           \\
                           &          &           &           \\
...
\begin{exercise}
    ...
    \begin{enumerate}[itemsep=1cm]
        \item Remplis le tableau ci-dessous. \\
              \begin{tblr}{hlines, vlines, colspec={*{3}{X[c]}}, rows={1cm}}
...
\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D7.png}
\end{exercise}

\newpage
\begin{exercise} 
    \par\includegraphics[]{img/CE1D1.png}
\end{exercise}

\newpage
\begin{exercise} 
    \par\includegraphics[]{img/CE1D2.png}
\end{exercise}

\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D3.png}
\end{exercise}

\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D4.png}
\end{exercise}

\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D5.png}
\end{exercise}

\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D6.png}
\end{exercise}

\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D8.png}
\end{exercise}

\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D9.png}
\end{exercise}

\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D10.png}
\end{exercise}

\newpage
\begin{exercise}
    \par\includegraphics[]{img/CE1D11.png}
\end{exercise}
\end{document}