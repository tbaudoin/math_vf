...
\begin{enumerate}
    \begin{multicols}{2}
% Mise en page un peu spéciale
    \item [\label=\ ]   \vspace{2cm} 
    \begin{center}
        \begin{tblr}{
                hlines,
                vlines,
   ...
   \vspace{2,5cm}
   \item Quel est la variable observée ?
   \vspace{2,5cm}
   \item Cette variable est-elle quantitative ou qualitative ?
   \vspace{2,5cm}
   ...
   \begin{center}
    \begin{tblr}{
        ...
        Variable & Effectif & Fréquence (en \%) \\ 
        & & \\
        & & \\
        & & \\
        & & \\
...
\begin{exercise}
    ...
    \begin{tabularx}{\textwidth}{|Y|Y|Y|Y|}
        \hline
        Variables & Effectifs & Fréquences & Amplitudes\\
        \hline
        & & & \\
        \hline
        & & & \\
