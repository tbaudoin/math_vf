...
\begin{exercise}
    ...
    \begin{enumerate}[cols = 2, itemsep = 1cm]
        \item [\label=]\includegraphics[]{img/velo.png}
...
\begin{enumerate}[cols = 2, itemsep = 2cm]
   ...
   \includegraphics[]{img/quadrillage.png}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{enumerate}[cols=2, itemsep = 2cm]
        \item [\label=]\includegraphics[]{img/tableua.png}
...
\begin{enumerate} [cols=2, itemsep = 2cm]
    ...
    \item [\label=] \includegraphics[]{img/combat_naval.png}
    \vspace*{2cm}
\end{enumerate}
\end{exercise}
