...
\begin{exercise}
  ...
  \begin{enumerate}
    ...
    \item $\dfrac{x}{3}\cdot(\dfrac{a}{2}-1)-4a\cdot(\dfrac{2x}{6}+\dfrac{1}{4})$
  \end{enumerate}
\end{exercise}
...
\begin{exercise}
  Effectue les distributivités suivantes et respecte bien les formules des puissances ($a,b,c,x$ sont non nuls). %\TODO:Un peu trop poussé et trop chargé pour moi. plus de produits remarquables me parait plus intéressant
  \newline
  Série 1
  \begin{enumerate}[cols=2]
    ...
    \item $(\dfrac{ac}{xb}+\dfrac{-x}{ab})\cdot(\dfrac{x}{bc}-\dfrac{ax}{a})$
    \item $(\dfrac{-a^8}{c^5}-\dfrac{x^7}{b^{10}})\cdot(\dfrac{-c^4}{a^3}+\dfrac{b^8}{x^2})$
    \item $-5\left(4a-5a^2\right)$
  \end{enumerate}
  Série 2
  \begin{enumerate}[cols=2]
    ...
    \item $(\dfrac{x^7}{a^8b^4}+\dfrac{a^3}{c^6})\cdot(\dfrac{c^7}{x^4}-\dfrac{c^3b^3}{a^5})$
    \item $(\dfrac{a^7b^8}{x^5}-\dfrac{a^2}{b^7x^4})\cdot(\dfrac{c^6x^4}{a^6}+\dfrac{b^5}{a^7})$
    \item $\dfrac{4a+2b^2}{2}\cdot (-3ab)$
  \end{enumerate}
\end{exercise}

\begin{exercise}
  Effectue les produits remarquables suivants. %\TODO:plus par produit remarquable
  \newline
  Série 1
...
\begin{exercise}
  Réduis au maximum les expressions suivantes. Veille à utiliser les produits remarquables quand nécessaire. %\TODO:Un peu plus encore?
  \newline
  Série 1
  \begin{enumerate}[cols=2]
...
\begin{exercise}
  Factorise les différences suivantes pour les transformer en produits de facteurs. %\TODO:Avec des trinomes carrés parfaits?
  \newline
  Série 1
  \begin{enumerate}[cols=2]
    \item $a^2-16$
...
\begin{exercise}
  ...
  \begin{center}
    \includegraphics[width=16cm]{chapitres/calcul-litteral/img/airecoloree.PNG} %\TODO: refaire la figure?
  \end{center}
\end{exercise}
