...
\begin{exercise}
  Effectue les distributivités suivantes et respecte bien les formules des puissances (a,b,c,x sont non nuls).
  \newline
  Série 1
  \begin{enumerate}
...
\begin{exercise}
  ...
  \begin{center}
    \includegraphics[width=16cm, valign=c]{img/airecolorée.png}
  \end{center}
\end{exercise}
