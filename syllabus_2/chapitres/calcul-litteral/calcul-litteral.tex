...
\begin{center} 
  ...
  S'il y a une "+" devant la parenthèse
  & $a + (b-c) = a + b - c$
  & On enlève la parenthèse et rien ne change\\
  S'il y a un "-" devant la parenthèse 
  & $a - (b-c) = a - b + c$
  & On distribue le "-" à chaque terme de la parenthèse \\
  S'il y a un "." devant la parenthèse
  & $a.(b+c) = ab + ac$
