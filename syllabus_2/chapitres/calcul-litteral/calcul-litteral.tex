...
\begin{exercise}
  Effectue les distributivités suivantes et respecte bien les formules des puissances.\\
  Série 1
  \begin{enumerate}[cols=2]
    \item $(x^3+7)\cdot(5 - 7x)$
    \item $(-a^{12}-5)\cdot(a^6-11)$
    \item $(x^0+y^3)\cdot(-y^2+4)$
    \item $(a^3-4+3)\cdot(-a -7)$
  \end{enumerate}
  Série 2
  \begin{enumerate}[cols=2]
...
\begin{exercise}
  Factorise les différences suivantes pour les transformer en produits de facteurs. 
  \newline
  Série 1
  \begin{enumerate}[cols=2]
    \item $a^2-16$
...
\begin{exercise}
  Factorise les sommes suivantes pour les transformer en produits de facteurs. 
  \newline
  Série 1
  \begin{enumerate}[cols=2]
    \item $16-8x+x^2$
...
\begin{exercise}
  (En dépassement) Effectue les distributivités suivantes et respecte bien les formules des puissances ($a,b,c,x$ sont non nuls). 
  \newline
  Série 1
  \begin{enumerate}[cols=2]
