...
\adf[Lorsqu'on élève une fraction à une puissance,]{2} %on élève le numérateur et le dénominateur à cette puissance
...
\dotsforanswer{3}[Deux fractions inverses (non nulles) sont] %deux fractions dont le numérateur de chacune d’elles est le dénominateur de l’autre.
...
Enfin, il est important de ne pas confondre inverse et opposé d'un nombre. \\
  \dotsforanswer{3}[Deux nombres (et donc fractions) sont opposés si] % ils ont la même valeur absolue mais sont de signes contraires. \\
...
\begin{exercise}
  Choisis une fraction. Prends son opposé. Additionne-les ensemble.\\
  Que vaut la somme? 
  \vfill
\end{exercise}

Écris les deux propriétés que tu viens de découvrir. 

\dotsforanswer {3}[Propriété des nombres inverses : ]

\dotsforanswer {3}[Propriété des nombres opposés : ]
...
\section{Priorité des opérations dans les fractions}
...
\begin{exercise}
  (Sur feuille annexe) Sachant que $p=\dfrac{-3}{2}$ et que $m=\dfrac{1}{3}$, calcule la valeur numérique de l'expression suivante.
