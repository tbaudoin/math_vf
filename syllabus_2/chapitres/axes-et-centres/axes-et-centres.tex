...
\begin{tasks}
    ...
    \begin{center}
        \includegraphics{img/tri_sca.png}
    \end{center} 
    \task Triangles isocèles
    \begin{center}
        \includegraphics{img/tri_iso.png}
    \end{center} 
    \task Triangles équilatéraux
    \begin{center}
        \includegraphics{img/tri_equi.png}
    \end{center}
\end{tasks}
...
\begin{itemize}[label=, cols=2]
    \item Polygone 1 \\
    \includegraphics[height=2cm]{img/penta.png}
    \item Polygone 2 \\
    \includegraphics[height=2cm]{img/enea.png}
\end{itemize}
\end{exercise}
...
\begin{exercise}
   ...
   \includegraphics{img/ex_retrouver.png}
\end{exercise}
...
\begin{exercise}
    ...
    \includegraphics{img/ex_geom.png}
\end{exercise}

\begin{exercise}
    Voici une rosace que Ines a réalisé pour décorer sa farde. 

    \centering \includegraphics[height=5cm]{img/rosace.png}
    \begin{tasks}
