...
\begin{exercise}
    ...
    \begin{enumerate}[itemsep=\fill, after=\vfill]
        ...
        \item La petite soeur de Joachim arrive au moment du partage. Joachim reprend alors tous ses chocolats et les redistribue en comptant sa petite sœur. Combien chacun des amis et la petite sœur va-t-il recevoir de chocolats~? Va-t-il en rester à Joachim~?
...
\begin{exercise}
    ...
    \begin{enumerate}[itemsep=\fill, after=\vfill]
        ...
        \item \textbf{Deuxième partie :} Marie vient se joindre à elles. Combien de cartes recevront-elles alors chacune ? Combien de cartes ne seront pass distribuées ?
...
Déduis une propriété en observant les nombres de départ et leur PGCD.
\begin{enumerate}[cols=2]
...
\begin{exercise}
    ...
    \begin{enumerate}
        \item \dots 18 ? \dotfill
        \item \dots 40 ? \dotfill
        \item \dots 36 ? \dotfill
    \end{enumerate}
\end{exercise}
