...
\begin{exercise}
    ...
    \centering\includegraphics{img/cartes.png}
...
\begin{center}
    \includegraphics[width=.4\linewidth]{img/coffre1.png}
\end{center}
...
\begin{center}
    \includegraphics[]{img/allumettes.jpg}
    \hfil
    \includegraphics{img/allumettes_schema.png}
\end{center}
