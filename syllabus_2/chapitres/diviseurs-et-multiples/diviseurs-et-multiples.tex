...
\begin{enumerate}[itemsep=1cm]
    ...
    \item Si un nombre en divise deux autres, alors \dots
          ...
          \newpage
    \item \dots sont des diviseurs de 24
          \begin{enumerate}[cols=4, label={\faIcon[regular]{square}}]
              \item 3
              \item 24
              \item 1
...
\dotsforanswer{2}[Un nombre premier est] %un nombre naturel qui n'admet que deux diviseurs distincts : 1 et lui-même
\exemples 

\vfil

\dotsforanswer{2}[Deux nombres premiers entre eux sont ]% deux nombres qui n'admettent que le nombre 1 comme diviseur commun
\exemples

\vfil

\begin{exercise}
    Souligne en vert les nombres premiers et entoure en rouge les duos de nombres premiers entre eux. 
...
\newpage
\begin{exercise}
    L'ensemble des élèves de deuxième année primaire et 5 professeurs aimeraient partir en excursion dans un parc d'attractions.
...
\begin{center}
    \begin{tblr}{
            hlines,
            vlines,
            columns={.45\linewidth,c},
            rows={1cm,m},
            row{1}={gray!40, font=\bfseries, m}
        }
        Étapes                                                                           & Exemples \\
...
\begin{exercise}
    Résous les problèmes ci-dessous, à l'aide des expressions générales. Écris tous tes calculs.
    \begin{enumerate}[itemsep=6cm]
        ...
        \item 35 est la somme de deux multiples de 5 consécutifs. Quels sont ces nombres?
    \end{enumerate}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{enumerate}[cols=2, itemsep= 5.7cm]
        \item 45 et 7
        \item 120 et 144
        \item 540 et 168
        \item 80 et 320
...
\dotsforanswer{4}[Propriété 3 : ]%SI un nombre est divisible par deux nombres premiers entre eux, alors il est divisible par leur produit
%COntre exemple : pour etre divisible par 12, il faut etre divisible par 3 et 4 , mais pas par 6 et 2 sinon 18 serait divisible par 12.
...
\begin{enumerate}
    ...
    \item Combien de boites d'allumettes de ces dimensions peut-on mettre dans cette boite ?\vspace*{4cm}
\end{enumerate}
...
\begin{exercise}
    ...
    \begin{enumerate}
        \item Détermine le nombre de sachets qu'il peut réaliser pour qu'il ne reste aucun bonbon.
        \item Détermine le nombre de bonbons de chaque sorte contenu dans un sachet.
    \end{enumerate}
\end{exercise}
\begin{solution}
    \begin{enumerate}
...
\begin{exercise}
    Quel est le plus petit carré que l'on peut former avec des rectangles de \(\SI{12}{cm}\times\SI{16}{cm}\)~? \\ Combien de rectangles seront utilisés~?
\end{exercise}
\begin{solution}
    \(PPCM(12,16) = 48\). 
...
\begin{exercise}
    ...
    \begin{enumerate}
        \item Quelle est la taille maximale de dalles carrées qui couvrent exactement la surface de cette salle de bain~?
        \item Combien de dalles de cette taille doit-il utiliser~?
    \end{enumerate}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{enumerate}
        \item Quelles sont les dimensions de la plus petite caisse cubique qui conviendra~?
        \item Combien de briques contiendra-t-elle~?
    \end{enumerate}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{enumerate}
        \item La somme de trois nombres consécutifs est multiple de $3$.
        \item La somme de deux multiples consécutifs de $5$ est un multiple de $5$.
    \end{enumerate}
\end{exercise}
