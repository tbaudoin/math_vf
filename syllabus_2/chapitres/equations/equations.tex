...
\begin{exercise}
  ...
  tes étapes.
  \begin{enumerate}[cols=2, itemsep=2.7cm]
    \item $7x = 42$
    \item $891 = 3x$
    \item $48 = \dfrac{x}{2}$
    \item $- 6x = 702$
...
\end{align*}
\vspace{1cm}
\minisec{Le produit en croix}
Dans une égalité de rapports, le produit des moyens est égal au produit des extrêmes.
\exemples 
%insister oralement sur le fait que le produit en croix est parfois pas utile

\newpage
\begin{exercise}
  Résous les équations suivantes.
  \begin{enumerate}[cols=2, itemsep=5.5cm]
...
\begin{exercise}
  Dans les cas suivants, isole \(y\). 
  \begin{enumerate}[cols=2, itemsep=2cm]
    \item \(\dfrac{y}{p}=m\cdot t\)
    \item \(\left(y-x\right) \cdot 2 = m\)
    \item \(\dfrac{y\cdot t}{x} = 8x\)
    \item \(\dfrac{2x}{y} = \dfrac{3t}{x}\)
  \end{enumerate}
\end{exercise}

\newpage
\section{Mise en équation et résolution de problèmes}
Les équations sont un outil très puissant pour trouver des solutions dans des situations concrètes. La difficulté est essentiellement de convertir notre problématique en une équation.
...
\begin{exercise}
  ...
  \begin{enumerate}
    ...
    \item On a augmenté de \SI{2}{cm} chacun des côtés d'un carré. Le périmètre du carré agrandi vaut \SI{50}{cm}. Que mesurait le côté du carré avant l'agrandissement ? 
...
\begin{exercise}
  \begin{enumerate}[itemsep=10cm]
    ...
    \item Détermine la mesure de $b$ dans la figure suivante si tu sais que son
          périmètre vaut $56$.
          \begin{center}
            \input{figures/probleme-perimetre01.tikz}
          \end{center}
    \newpage
    ...
    \item Le périmètre du petit magasin de bricolage de ta ville (qui est
          ...
          \begin{center}
            \input{figures/probleme-perimetre02.tikz}
          \end{center}
  \end{enumerate}
\end{exercise}
