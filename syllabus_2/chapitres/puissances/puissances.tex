...
%===============================================================================
\begin{exercise}
	À quelles conditions une puissance est-elle un nombre négatif?
	\vspace{2cm}
\end{exercise}

\begin{exercise}
	Traduis chaque expression par une phrase puis effectue.
...
\begin{exercise}
	Effectue les opérations en écrivant les étapes de ton raisonnement.
...
%===============================================================================
%===============================================================================
\begin{enumerate}[cols=2, itemsep=2.5cm]
	\item \(5^3 \cdot 5=\)
	\item \(5^2 \cdot 5^4=\)
	\item \(5^2 \cdot 5^3=\)
	\item \(5^5 \cdot 5=\)
...
\begin{center}
	\mybox{\(a^b\cdot a^c=\hspace*{1 in}\)}
\end{center}
...
\begin{center}
	\mybox{\(\dfrac{a^b}{a^c}=\hspace{1in}\)}
\end{center}
...
\adf[Lorsqu'on élève une fraction à une puissance, on ]{2}

\begin{center}
	\mybox{\(\left(\dfrac{a}{b}\right)^c=\hspace{1in}\)}
\end{center}
...
\begin{tblr}{hlines, vlines,row{1}={c,gray!40, font=\bfseries},
	rowsep=1.5ex, colspec={X[l]X[l]}}
...
\adf[Les puissances de 10 à exposants positifs représentent]{1} % de très grands nombres


\adf[Les puissances de 10 à exposants négatifs représentent]{1} % de très petits nombres
...
\begin{exercise}
	Effectue.
	\begin{enumerate} [cols=2, itemsep=1.7cm]
		\item \(8\cdot 10^9=\)
		\item \(12\cdot 10^{-2}=\)
		...
		\item \(3 \cdot 10^{-2} \cdot 10^3=\)
		\item \(0,006 \cdot (10^2)^2=\)
		\item \(345 \cdot (10^2)^{-3}=\)
		\item \(0 \cdot 10^{-7}=\)
	\end{enumerate}
\end{exercise}
