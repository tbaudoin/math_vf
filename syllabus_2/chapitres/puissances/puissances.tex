...
\begin{tblr}{hlines, vlines, columns={c},column{2,3}={3cm}, row{1}={gray!40, font=\bfseries}, rowsep=1ex}
...
\begin{tblr}{hlines, vlines, columns={l, .5\linewidth},row{1}={c,gray!40, font=\bfseries}, rowsep=1ex}
