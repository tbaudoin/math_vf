...
\begin{exercise}
	Dans l'exemple suivant, redonne à chaque élément le vocabulaire adéquat. 
	\vspace*{1cm}
	\begin{center}
		$-8^2$
	\end{center}
...
\begin{enumerate}[itemsep=5em, cols=2]
	\item $\dfrac{2^5}{2}=$
	\item $\dfrac{2^5}{2^2}=$
	\item $\dfrac{2^5}{2^3}=$
	\item $\dfrac{2^5}{2^4}=$
...
\begin{exercise}
	...
	\begin{enumerate} [cols=2]
		\item $\dfrac{6^7}{6^5}=$
		\item $\dfrac{19^9}{19^3}=$
		\item $\dfrac{(-8)^7}{(-8)^3}=$
		%%	\item $\dfrac{(\frac{3}{4})^}10}{(\frac{3}{4})^8}$
