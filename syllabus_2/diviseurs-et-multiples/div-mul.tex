...
\begin{tasks}
    \task Dans cette division écrite,
    ...
    \task Le quotient entier de 100 par 20 est \dots
    ...
    \task Si un nombre en divise deux autres, alors \dots
    \begin{enumerate}[cols=2, label={\faIcon[regular]{square}}]
    ...
    \task Un nombre est divisible par 3 si \dots
    ...
    \task Ces deux nombres sont premiers entre eux :
    \begin{enumerate}[cols=4, label={\faIcon[regular]{square}}]
        \item 20 et 15
        \item 13 et 80
        \item 2 et 3
    ...
    \task Quels sont les nombres premiers  ?
    \begin{enumerate}[cols=4, label={\faIcon[regular]{square}}]
        \item 37
        \item 53
        \item 91
    ...
    \task Je suis un multiple de 4 compris entre 35 et 45.
    \begin{enumerate}[cols=4, label={\faIcon[regular]{square}}]
        \item 40
        \item 36
        \item 42
...
\begin{exercise}
    ...
    \begin{tasks}[after-item-skip=4.5cm, after-skip=4.5cm]
...
\begin{exercise}
    ...
    \centering\includegraphics{diviseurs-et-multiples/imgd/cartes.png}
    \begin{tasks}[after-item-skip=3.5cm, after-skip=3.5cm]
...
\begin{exercise}
    ...
    \begin{tasks}[after-item-skip=4cm, after-skip=6cm](3)
        \task $59 : 3$
        \task $829 : 4$
        \task $834 : 7$
    \end{tasks}
\end{exercise}
%laisser de nouveau full espace pour qu'ils puissent faire les div. euclidiennes
\newpage
\begin{exercise}
    Quel est le nom de 19 dans les égalités euclidiennes suivantes?\\
    \begin{tasks}
        \task $139=20\cdot 6+19$\hfill\dotfillbox[8cm]
        \task $19=3\cdot 5+4$\hfill\dotfillbox[8cm]
        \task $499=25\cdot 19+24$\hfill\dotfillbox[8cm]
        \task $81=4\cdot 19+5$\hfill\dotfillbox[8cm]
    \end{tasks}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{center}
        ...
        \begin{tabularx}{.8\linewidth}{|*{4}{>{\centering}p{1cm}|}Y|}
            \hline
            \textbf{D} & \textbf{d} & \textbf{q} & \textbf{r} & \textbf{égalité} \\
            \hline
            56         & 9          &            &            &                  \\
            \hline
                       & 8          & 4          & 3          &                  \\
...
\begin{tasks}
    \task 3 nombres consécutifs :\dotfill
    \task Un nombre pair :\dotfill
    \task Un nombre impair :\dotfill
    \task Deux nombres pairs consécutifs :\dotfill
    \task Trois nombres impairs consécutifs :\dotfill
    \task Un multiple de 3 :\dotfill
    \task Deux multiples de 5 consécutifs :\dotfill
    \task Un multiple de 9 augmenté de 1 :\dotfill
\end{tasks}
...
\begin{exercise}
    ...
    \begin{tasks}[after-item-skip=4cm, after-skip=4cm]
...
\begin{exercise}
    ...
    \begin{tasks}[after-item-skip=8cm]
...
\begin{center}
    \includegraphics[width=.4\linewidth]{diviseurs-et-multiples/imgd/coffre1.png}
\end{center}

\begin{tasks}
    \task Quelles peuvent être les dimensions de ces cubes (si on ne prend que les dimensions entières de centimètres) ?
    \adf{2}
    \task Quelles sont les plus grandes dimensions possibles ?
    \adf{1}
    \task Combien y aura-t-il de cubes de cette dimension dans le coffre ?
    \adf{4}
    \task Il existe un moyen de trouver directement la réponse à la question $b$ à l'aide de la décomposition en facteurs premiers de 24, 36 et 60. Quel est-il?\\
...
\newpage
\section{Propriétés du PGCD et des nombres premiers entre eux}
...
\begin{itemize}[label=$\bullet$]
    \item Un nombre est divisible par 6 si \dotfill
    \item Un nombre est divisible par 75 si \dotfill
\end{itemize}
...
\begin{exercise}
    À quelle condition un nombre est-il divisble par \dots
    \begin{tasks}
        \task \dots 18 ? \dotfill
        \task \dots 40 ? \dotfill
        \task \dots 36 ? \dotfill
...
\begin{center}
    \includegraphics[]{diviseurs-et-multiples/imgd/allumettes.jpg}
    \hfil
    \includegraphics{diviseurs-et-multiples/imgd/allumettes_schema.png}
\end{center}

\begin{enumerate}
    \item Quelles pourraient être les dimensions (en nombre entier de centimètres) de la caisse en carton?
          \adf{2}

    \item Quelles sont les dimensions entières de la plus petite caisse en carton possible?
          \adf{1}

    \item Combien de boites d'allumettes peut-on mettre?
          \adf{4}

    \item Il existe un moyen de trouver la réponse à la question $b$, directement avec la décomposition en facteurs premiers de 4, 8 et 10. Quel est-il?
...
% laisser à nouveau de la place pour trouver les PGCD demandés
\adf[Propriété 1 :]{1}
...
%\begin{exercise}
%    Complète le tableau suivant avec $a$, $b$ \in \mathbb{N} \\
