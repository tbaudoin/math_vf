...
\faIcon{book} Théorie pages 136 à 140 \textbf{et} pages 157 à 158
...
\vspace*{0.5cm}
\begin{center}
  \includegraphics[width=3cm]{calcul-litteral/img/5a.pdf}
\end{center}
...
\newpage
\adf[Dans une somme (ou une différence) algébrique, on ne peut réduire que ]{1}
\exemples
...
\adf[Dans une produit algébrique, on multiplie]{1}
\exemples
\begin{itemize} [cols=2, label=]
  \item $-3a\cdot 6ab^3=$
  \item $5a\cdot (-7a^6)=$
...
\adf[Pour effectuer une distributivité simple,]{1}
\exemples
\begin{itemize}[cols=2, label=]
...
\newpage
\section{Produits remarquables : le carré d'une somme}
...
\newpage
\section{Produits remarquables : le carré d'une différence}
...
\newpage
\section{Produits remarquables : les binômes conjugués}
...
\newpage
\begin{exercise}
  Mofidie légèrement l'écriture ci-dessous pour que les binômes conjugués apparaissent plus clairement, puis développe en utilisant la formule.
  \begin{enumerate}[cols=2]
...
\begin{exercise}
  ...
  \begin{enumerate}[cols=2]
    ...
    \item [\label=~] \includegraphics[width=3cm]{calcul-litteral/img/carredunesomme.jpg}
  \end{enumerate}
\end{exercise}
...
\begin{exercise}
  ...
  \includegraphics[valign=t]{calcul-litteral/img/aireetperi.png}
\end{exercise}
...
\begin{exercise}
  ...
  \begin{center}
    \includegraphics[width=6cm, valign=c]{calcul-litteral/img/parall.jpg}
    \parbox{5cm}{
      $|AB| = x + 2$\\
      $|GC| = 9 - x$\\
      $|AD| = 1 + 2x$
...
\begin{exercise}
  ...
  \begin{center}
    \includegraphics[valign=t]{calcul-litteral/img/fig.1.png}
    \hfil
    \includegraphics[valign=t]{calcul-litteral/img/fig.2.png}
  \end{center}
\end{exercise}
\end{document}