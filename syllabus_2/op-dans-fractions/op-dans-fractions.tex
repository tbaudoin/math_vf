...
\begin{exercise}
  Voici les valeurs de $a$, $b$, $c$ et $d$. Calcule si 
  \vspace{1cm}
  $a=\dfrac{6}{8}$, 
  $b=\dfrac{-3}{2}$,
  $c=\dfrac{1}{2}$ et 
...
\begin{exercise}
  ...
  \begin{enumerate}[cols=2, itemsep=4cm]
    ...
    \item  $\dfrac{25x^5y^{10}}{x^5y^{15}} \cdot \dfrac{10x^5y}{15x}=$
    \item  $\dfrac{16x^3y^8}{x^5y} \cdot \dfrac{1}{18 x^6 y^6 z}=$
    \item  $\dfrac{18 x^{15} y^{20}}{x^{14} y^{19}} \cdot \dfrac{x^6}{6 x^5}=$
...
\begin{center}
\includegraphics[width=3cm]{op-dans-fractions/Img/Inverse002.pdf}
\end{center}

Pour rappel, tout nombre entier peut être écrit sous forme d'une fraction.
\begin{center}
  \includegraphics[width=3cm]{op-dans-fractions/Img/Inverse003_Entiers.pdf} 
\end{center}
...
\begin{exercise}
  Complète les phrases suivantes par le vocabulaire adéquat.
...
\begin{enumerate}[label=\arabic*]
  ...
  \item Réduire au maximum le résultat obtenu
\end{enumerate}
...
\begin{exercise}
  Mikail remarque qu'il a déjà utilisé \(\dfrac{4}{5}\) de son forfait GSM ce mois-ci. Il utilise les \(\dfrac{5}{6}\) de ce qu'il lui reste pour appeler Samuel. De quelle fraction de son forfait dispose-t-il encore~? \\
...
\begin{exercise}
  ...
  \includegraphics[center]{op-dans-fractions/Img/Ex_CE1D.pdf}
...
\begin{exercise}
  Juliette veut planter des fleurs sur un quart de son jardin, et créer une marre sur les trois dixièmes de son jardin. Sur la surface qu'il lui reste, elle compte semer de l'herbe. \\
...
\begin{center}
  \input{op-dans-fractions/tikz/fig_abcd.tikz}
\end{center}
