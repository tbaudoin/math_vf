...
\begin{exercise}
  ...
  \begin{enumerate}[itemsep=10cm]
    \item
          Jean et sa s\oe{}ur perçoivent leur rétribution pour un travail de
          vacances. La s\oe{}ur de Jean perçoit 100~€ de plus que Jean ;
          ensemble, ils ont \np{1000}~€. Combien ont-ils chacun gagné~?
    \item
          Victor, Maxence et Zoé ont cueilli $152$ pommes. Maxence en a
    ...
    \item
          La somme de $3$ nombres consécutifs vaut $129$. Quels sont ces
          nombres~?
    \item
          Détermine la mesure de $b$ dans la figure suivante si tu sais que son
          périmètre vaut $56$.
          \begin{center}
            \input{equations/tikz/probleme-perimetre01.tikz}
          \end{center}
    \item
          Les $\dfrac{2}{3}$ d'un nombre augmentés de $10$ valent $60$.
          Quel est ce nombre~?
    \item
          Le périmètre du petit magasin de bricolage de ta ville (qui est
          représentée par le plan ci-contre) est égal à \SI{62}{m}.
          \begin{center}
            \input{equations/tikz/probleme-perimetre02.tikz}
          \end{center}
  \end{enumerate}
\end{exercise}

\newpage
\section{Exercices mélangés (sur ta feuille annexe)}
\begin{exercise}
...
\newpage
\begin{exercise}
Résous ces équations. Attention à la présentation
