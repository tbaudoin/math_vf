...
\section*{Vocabulaire}
\begin{tblr}{|m{2cm}|p{10cm}|p{3cm}|}
    \hline
    Mot & \begin{center}Définition\end{center} & Dans notre exemple d'introduction \\
    \hline
    Variable & \dotfill & \\
    & \dotfill & \\
    & \dotfill & \\
...
\begin{exercise}
    ...
    \begin{tblr}{|m{2cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|m{2cm}|}
        \hline
...
\begin{exercise}
    ...
    \begin{enumerate}[cols = 2, itemsep = 1cm]
        \item [\label=]\includegraphics[]{traitement-de-donnees/img/velo.png}
...
\begin{enumerate}[cols = 2, itemsep = 2cm]
   ...
   h)  Complète le tableau de distribution des cotes des élèves de 2G ci-dessous. \\
   ...
   i)  Trace le diagramme en bâtonnets qui représente la répartition des notes pour les élèves de 2G. \\
   \includegraphics[]{traitement-de-donnees/img/quadrillage.png}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{center}
           \includegraphics[]{traitement-de-donnees/img/voitures.png}
    \end{center}
    ...
    \begin{enumerate} [ itemsep=1.5cm]
       ...
       \item Ce caractère est-il quantitatif ou qualitatif ?
       \item Quel est l’effectif total ?
       \item Quelle est la probabilité qu’une voiture vendue prise au hasard soit bleue ?
       \item Peut-on calculer l’étendue de cette série ?
        
    \end{enumerate}
\newpage
    i)  Complète le tableau de distribution des couleurs de voitures du garage de « Thomas et fils » et calcule l’amplitude des angles afin de tracer un diagramme circulaire. \\

    {\renewcommand{\arraystretch}{2}
    \begin{tabularx}{\textwidth}{|Y|Y|Y|Y|}
        \hline
        Modalités & Effectif & Fréquences & Amplitudes\\
        \hline
        & & & \\
        \hline
        & & & \\
    ...
    j) Trace le diagramme circulaire de la situation dans un cercle de $3 cm $ de rayon. N'oublie pas ta légende ! 
    \vspace*{6cm}
...
\begin{exercise}
    ...
    \begin{enumerate}[cols=2, itemsep = 2cm]
        \item [\label=]\includegraphics[]{traitement-de-donnees/img/tableua.png}
        \item L'effectie total est 163
...
\begin{exercise}
    ...
    \begin{tabularx}{\textwidth}{|p{3.5cm}|Y|Y|Y|Y|Y|Y|Y|Y|Y|}
        \hline
...
\begin{exercise}
    ...
    \begin{center}
     \includegraphics[]{traitement-de-donnees/img/natura.png}   
    \end{center}
    ...
    \begin{enumerate} [cols=2, itemsep = 2cm]
        ...
        \item Quel est, en moyenne, le nombre d'oiseaux observés?
        \item Combien de personnes ont observé un nombre d'oiseaux supérieur à la moyenne?
        \item Quel est le pourcentage d'oiseaux observés par 4 personnes?
    \end{enumerate}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{tabularx}{\linewidth}{|p{5cm}|Y|Y|Y|Y|Y|Y|}
        \hline
        Somme en € & 2 & 5 & 8 & 11 & 14 & 17 \\
        \hline
        Nombres d'élèves & 2 & 7 & & & & \\
        \hline
...
\begin{exercise}
    ...
    \begin{tabularx}{\linewidth}{|p{4cm}|Y|Y|Y|Y|Y|Y|Y|Y|Y|}
        \hline
...
\newpage
\begin{exercise}
Alice a obtenu trois cotes sur 20 (12, 17 et 16) en mathématiques pour le bulletin de la dernière période. Son professeur a donné autant d’importance à chaque interrogation. Mais en fin de période, le professeur a décidé d’organiser un bilan dont l’importance est double par rapport à chaque interrogation précédente. \\ Combien Alice doit-elle obtenir à cette interrogation pour avoir une moyenne de 80\% ?
\end{exercise}

\vspace*{3cm}

\begin{exercise}
Un agent immobilier prévoit de promouvoir la ville de \textit{Lounialand}. Pour ça, il a besoin de faire quelques relevés. \\ Voici les surfaces habitables, en $m^2$, de neuf maisons du quartier de \textit{La Calista}.\\
...
\begin{exercise}
  ...
  \begin{enumerate}[itemsep=1cm]
      ...
      \begin{tabularx}{\linewidth}{|Y|Y|Y|}
        \hline
          Taille des chaussures & Nombre de joueurs & Fréquence \\
          \hline 
          & & \\
          \hline 
          & & \\
...
\begin{exercise}
    ...
    \begin{tabularx}{\linewidth}{|p{5cm}|Y|Y|Y|Y|Y|}
        \hline
...
\begin{enumerate} [cols=2, itemsep = 2cm]
    ...
    \item [\label=] \includegraphics[]{traitement-de-donnees/img/combat_naval.png}
    \vspace*{2cm}
\end{enumerate}
\end{exercise}
...
\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D7.png}
\end{exercise}

\newpage
\begin{exercise} \\
    \includegraphics[]{traitement-de-donnees/img/CE1D1.png}
\end{exercise}

\newpage
\begin{exercise} \\
    \includegraphics[]{traitement-de-donnees/img/CE1D2.png}
\end{exercise}

\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D3.png}
\end{exercise}

\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D4.png}
\end{exercise}

\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D5.png}
\end{exercise}

\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D6.png}
\end{exercise}

\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D8.png}
\end{exercise}

\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D9.png}
\end{exercise}

\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D10.png}
\end{exercise}

\newpage
\begin{exercise}\\
    \includegraphics[]{traitement-de-donnees/img/CE1D11.png}
\end{exercise}