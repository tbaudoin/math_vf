...
Rappel pour la classe : 
\og
Merci de respecter les règles du jeu ainsi que les meneurs de jeu et les autres participants.
\fg
...
Rappel :
\begin{itemize}
    \item Périmètre : \(2 \cdot \pi \cdot r\)
    \item Aire : \(\pi \cdot r^2\)
    \item Volume : \(\dfrac{4}{3} \cdot \pi \cdot r^3\)
\end{itemize}
\end{document}